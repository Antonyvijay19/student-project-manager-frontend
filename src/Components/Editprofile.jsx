...
function EditProfile() {
    ...
    return (
        <div className="flex justify-center items-center h-screen bg-gradient-to-r from-gray-950 to-gray-300 rounded-lg">
            <form onSubmit={handleSubmit} className="flex flex-col p-10 bg-white rounded-lg shadow-md w-[75%]">
             ...
             <button className=' px-5 py-[10px] rounded-md font-bold text-center w-[150px] shadow-md text-white bg-gradient-to-l from-red-700 to-red-400'>
                    Save Changes
             </button>
                <button className="w-[90px] px-4 py-[10px] rounded-md bg-gray-500 text-white font-bold hover:bg-gray-600" onClick={()=>{navigate('/profile')}}>
                    Cancel
                 </button>
             </div>
